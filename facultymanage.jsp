...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h3 class="subTitle">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=path%>/addfaculty.do">增加学院</a>
        </h3>
        <br />
        <table width="90%" border="0" align="center" cellpadding="0"
               cellspacing="0" class="table3">
            <tr align="center">
                <td width="138" height="51">学院名称</td>
                <td width="162">描述</td>
                <td width="94">修改操作</td>
                <td width="116">删除操作</td>
            </tr>
            <c:forEach var="sc" items="${facultyList}" varStatus="id">
                <tr align="center">
                    <td>${sc.name}</td>
                    <td>${sc.remark}</td>
                    <td><a href="<%=path%>/facultyModify.do?name=${sc.name}">修改</a></td>
                    <td><a href="<%=path%>/facultyDelete?name=${sc.name}">删除</a></td>
                </tr>
            </c:forEach>
        </table>
        <br />
