...
<div class="text2">
  <form action="<%=path %>/addStudent" method="post" name="form1" id="form1" enctype="multipart/form-data">
    <table width="900" border="0" align="center" class="word_darkGrey">
      ...
      <tr>
        <td>政治面貌：</td>
        <td width="195"><label>
          <input type="text" name="politics" id="politics" />
        </label></td>
      </tr>
      <tr><!-- 当点击登录则需要在CheckLogin.jsp进行判断,点击注册会跳转到注册界面 -->
            <th>头像图片</th>
            <td><input type="file" name="photo" maxlength="16" required="required"/></td>
    </tr>
      <tr>
