...
<div class="text2">
    <form action="<%=path %>/teacherModify" method="post" name="form1" id="form1">
        <table width="900" border="0" align="center" class="word_darkGrey">
                    ...
                    <tr>
                        <td>生日：</td>
                        <td width="195"><label>
                                <input type="date" name="birthday" id="birthday" value="${teacher.birthday }"/>
                            </label></td>
                    </tr>
                    <tr>
                        <td>邮箱：</td>
                  ...
                  <tr>
                        <td width="132">简介：</td>
                        <td width="195"><label>
                                <input type="text" name="remark" id="remark" value="${teacher.remark }"/>
                            </label></td>
                    </tr>
                    <tr>
